...
add_image_size('landing-block-background-full', 1200);
add_image_size('landing-block-background-half', 1000);
 ...
 */
	...
	function html5reset_scripts_styles() {
		...
		wp_enqueue_style( 'buddyboss-child-css', get_stylesheet_directory_uri().'/css/navdock.css', '', '1.0.1' );
