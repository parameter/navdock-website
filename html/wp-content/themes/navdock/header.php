...
<div class="navdock-page__wrapper">

	<header class="navdock-page__header">
		<div class="navdock-page__header-inner">
			<img class="navdock-page__header-logo" src="<?php echo get_stylesheet_directory_uri() ?>/img/navdock-logotype.png" alt="" />

			<ul class="navdock-page__main-menu">
